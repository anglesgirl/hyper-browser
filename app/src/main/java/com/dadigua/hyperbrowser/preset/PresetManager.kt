...
class PresetManager(private val context: Context) {
    ...
    companion object {
        ...
        // Mirrors ExtensionRepository.INTERNAL_EXTENSION_ID; duplicated here to keep
        // PresetManager compiling in isolation while BrowserActivity/ExtensionRepository
        // are temporarily reverted for ECH regression bisection.
